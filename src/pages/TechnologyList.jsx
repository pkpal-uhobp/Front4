...
const TechnologyList = () => {
  ...
  const handleRandomTechnology = () => {
    const notCompleted = technologies.filter(t => t.status !== STATUS.COMPLETED);
  ...
  return (
    <Container maxWidth="lg" sx={{ py: 4 }}>
                  ...
                  <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                    <Box
                      sx={{
                        ...
                        height: 12,
                        borderRadius: '50%',
                        backgroundColor: STATUS_COLORS[STATUS.NOT_STARTED]
                      }}
                    />
                  ...
                  <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                    <Box
                      sx={{
                        ...
                        height: 12,
                        borderRadius: '50%',
                        backgroundColor: STATUS_COLORS[STATUS.IN_PROGRESS]
                      }}
                    />
                  ...
                  <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                    <Box
                      sx={{
                        ...
                        height: 12,
                        borderRadius: '50%',
                        backgroundColor: STATUS_COLORS[STATUS.COMPLETED]
                      }}
                    />
      ...
      <Box sx={{ display: 'flex', gap: 1, mb: 3, flexWrap: 'wrap' }}>
        ...
        {statusFilter !== 'all' && (
          <Chip
            label={`Фильтр: ${STATUS_LABELS[statusFilter]}`}
            onDelete={() => setStatusFilter('all')}
            size="small"
            sx={{ backgroundColor: STATUS_COLORS[statusFilter], color: 'white' }}
          />
        )}
      </Box>
