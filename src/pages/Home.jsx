      ...
      <Container maxWidth="md" sx={{ py: 4 }}>
        <Box sx={{ textAlign: 'center', mb: 4 }}>
          ...
          <Typography variant="body1" color="text.secondary" sx={{ mb: 4, maxWidth: 600, mx: 'auto' }}>
            Загрузите дорожную карту в формате JSON, чтобы начать отслеживать свой прогресс
            в изучении новой технологии или направления.
          </Typography>
        </Box>
        ...
        <Box sx={{ mt: 4, textAlign: 'center' }}>
          <Alert severity="info" sx={{ display: 'inline-flex', maxWidth: 600 }}>
            <Typography variant="body2">
              Дорожная карта должна быть в формате JSON с полями: title, description (опционально),
              и items (массив пунктов с id, title, description, resources).
            </Typography>
          </Alert>
        </Box>
      </Container>
    ...
    <Container maxWidth="lg" sx={{ py: 4 }}>
        ...
        <Grid size={{ xs: 12, sm: 6 }}>
          ...
          >
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
              <ListAltIcon sx={{ fontSize: 48, color: 'primary.main' }} />
              <Box>
      ...
      <Box sx={{ mt: 4, textAlign: 'center' }}>
        <Button
          ...
          color="inherit"
          onClick={() => {
            if (window.confirm('Загрузка новой карты заменит текущую. Продолжить?')) {
